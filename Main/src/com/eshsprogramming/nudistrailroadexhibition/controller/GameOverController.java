...
public class GameOverController
{
	...
	{
		if(textTouched(touchPosition, ((GameOverRenderer) game.gameOverScreen.getRenderer()).getWorld().getReturnText()))
		{
	...
	private boolean textTouched(Vector2 touchPosition, Text text)
	{
		...
		float width = (text.getWidth() / game.gameOverScreen.getWidth()) * MainMenuRenderer.CAMERA_WIDTH;
		float height = (text.getHeight() / game.gameOverScreen.getHeight()) * MainMenuRenderer.CAMERA_HEIGHT;
